# Installation of GM Network Mach AVS using docker
...
## Setup GM Network Mach AVS

The easiest way to set up GM Network Mach AVS is to clone the repo and follow the instructions below.
